...
const Header: React.FC<HeaderProps> = (props) => {
  ...
  return (
    <div className="flex flex-row items-center px-2 md:px-10 w-full h-32">
      ...
      {props.isVerify && (
        <button className="transition-all flex flex-row items-center justify-center space-x-2 bg-glow-orange rounded-full p-2 pr-4 overflow-hidden hover:bg-white hover:text-glow-orange text-white py-2 font-extrabold text-xs sm:text-lg">
